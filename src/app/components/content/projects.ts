...
export const projectsContent = {
  ...
  projects: [
    ...
    {
      id: 8,
      title: "Backery Management System",
      description:
        "A full-stack backery management system built with Node.js, Next.js, PostgreSQL, Tailwind CSS, TypeScript, featuring user authentication, backery management, and mobile app integration for dilivery partners and admin.",
      technologies: ["Node.js", "Next.js", "PostgreSQL", "Tailwind CSS", "TypeScript","Flutter","Dart"],
      image: "/project6.jpg",
      github: "https://github.com/Dinukaawsh/backery-management-system",
      live: "https://backery-management.vercel.app/",
      category: "Full-Stack",
      featured: true,
      color: "bg-orange-500",
      delay: 1.4,
    ...
    {
      id: 9,
      title: "Scooply - Ice Cream Shop Management System",
      description:
        "A full-stack ice cream shop management system built with Node.js, Next.js, PostgreSQL, Tailwind CSS, TypeScript, featuring user authentication, ice cream shop management, and mobile app integration for business ownders, having google and facebook login to the system",
      technologies: ["Node.js", "Next.js", "PostgreSQL", "Tailwind CSS", "TypeScript","Flutter","Dart"],
      image: "/project6.jpg",
      github: "https://github.com/Dinukaawsh/Scooply-ice-cream-shop-management-system",
      live: "https://ice-cream-business.vercel.app/",
      category: "Full-Stack",
      featured: false,
      color: "bg-purple-500",
      delay: 1.6,
